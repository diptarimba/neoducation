	...
	<div class="col-md-6 col-12">
        <div class="card">
            ...
            <div class="card-body">
					...
					<div class="row justify-content-center">
						<a type="button" href="/managetentor/{{$tentor->id}}/edit" class="col-md-2 mx-1 my-1 btn btn-outline-primary">Edit</a>
						<a type="button" href="/managetentor/{{$tentor->id}}/result" class="col-md-2 mx-1 my-1 btn btn-outline-secondary">Hasil Quiz</a>
